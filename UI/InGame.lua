...
ContextPtr:LoadNewContext("PlaceCow")
ContextPtr:LoadNewContext("PlaceFish")
ContextPtr:LoadNewContext("Reforestation")
ContextPtr:LoadNewContext("PlaceBison")
ContextPtr:LoadNewContext("Great People Names")
ContextPtr:LoadNewContext("SerialEventUnitCreatedGood")
ContextPtr:LoadNewContext("InfoAddictInit")
ContextPtr:LoadNewContext("QuickTurns")
ContextPtr:LoadNewContext("QuickTurnsDialog")
ContextPtr:LoadNewContext("UniqueCulturalInfluence")
